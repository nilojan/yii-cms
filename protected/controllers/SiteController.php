...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
		...
		$Page = Page::model()->find('id=:ID', array('ID' => Yii::app()->config->get('home_page'))); 
		// keep 1st page as Home always if home page ID changed , change the value here depends on your Home page id
		
		//echo"<pre>";print_r($Page);echo"</pre>";
		//exit;
        $this->render('index_'.app()->layout, array('Page'=>$Page));
    }
